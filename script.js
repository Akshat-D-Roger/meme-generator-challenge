 ...
 */
function clearAll() {
  let list = document.querySelectorAll('.new');
  for (a of list) {
    a.innerHTML = '';
  }
}
...
function showMeme() {
  ...
  document.getElementById('meme').append(newElement);
}
...
function showJoke() {
  ...
  document.getElementById('joke').append(newElement);
}
...
function showQuote() {
  ...
  newElement.textContent = randomQuote.quote;
  author.textContent = randomQuote.author;
  document.getElementById('quote').append(newElement, author);
}
...
function showRiddle() {
  ...
  newElement.textContent = randomRiddle.question
  answer.textContent = randomRiddle.answer;
  answer.setAttribute('id', 'riddle-answer')
  answer.hidden = true;
  document.getElementById('riddle').append(newElement, answer);
}
...
function revealAnswers() {
  let riddleAnswer = document.getElementById('riddle-answer');
  if (!riddleAnswer) {
    alert('There is no riddle');
  }
  else {
    if (riddleAnswer.hidden === false)
